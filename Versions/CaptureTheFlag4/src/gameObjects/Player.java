...
//    boolean hasStealth = false;
    ...
    public void unpack(String s) 
    {
        ...
        launcher.unpack(parts[13]);
        for (int i = 14; i < parts.length; i++) { //Loops through all packed PowerUps adding them to the player ArrayList
    ...
    public Projectile fireWeapon()
    {
        ...
        return new Projectile(x,y,-3,-3,20,20);
    }
...
//    }
    ...
    public boolean isOnOwnSide()
    {
        ...
        {
            if (x > 1500) //NEED TO CONSIDER WIDTH OF PLAYER HERE ****
            {
                return true;
            }
        }
